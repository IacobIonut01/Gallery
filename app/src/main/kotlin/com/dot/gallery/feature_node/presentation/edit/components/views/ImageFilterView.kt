...
import com.dot.gallery.feature_node.presentation.edit.components.utils.BitmapUtil.createBitmapFromGLSurface
import com.dot.gallery.feature_node.presentation.edit.components.utils.CustomEffect
import com.dot.gallery.feature_node.presentation.edit.components.utils.GLToolbox.initTexParams
import com.dot.gallery.feature_node.presentation.edit.components.utils.PhotoFilter
import com.dot.gallery.feature_node.presentation.edit.components.utils.TextureRenderer
...
internal class ImageFilterView @JvmOverloads constructor(
    ...
    val hasFilterApplied get() = mCurrentEffect != PhotoFilter.NONE || mCustomEffect != null
    val currentFilter get() = mCurrentEffect
    val currentCustomFilter get() = mCustomEffect
