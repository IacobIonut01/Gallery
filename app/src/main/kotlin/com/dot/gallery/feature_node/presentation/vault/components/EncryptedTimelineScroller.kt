...
@Composable
fun BoxScope.EncryptedTimelineScroller(
    gridState: LazyGridState,
    mappedData: List<EncryptedMediaItem>,
    ...
    val headerList =
        remember(mappedData) { mappedData.filterIsInstance<EncryptedMediaItem.Header>() }
    ...
    Column(
        ...
        mappedData.forEachIndexed { i, header ->
            if (header is EncryptedMediaItem.Header) {
                Spacer(
                    modifier = Modifier
                        .width(16.dp)
