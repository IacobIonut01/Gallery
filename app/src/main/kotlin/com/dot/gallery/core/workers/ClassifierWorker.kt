...
import com.dot.gallery.feature_node.presentation.classifier.ImageClassifierHelper
...
class ClassifierWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result = runCatching {
        ...
        val noClassify =
            Settings.Misc.getSetting(appContext, Settings.Misc.NO_CLASSIFICATION, false)
                .firstOrNull()
        if (noClassify == true) {
